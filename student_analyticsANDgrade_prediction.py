...
# Accuracy and Report
print("Accuracy of K-Means: ", accuracy_score(Y_train, mapped_labels))
print("Classification Report of K-Means: ", classification_report(Y_train, mapped_labels))
...
accuracies = [
    ...
    accuracy_score(Y_test, mapped_labels)
]
